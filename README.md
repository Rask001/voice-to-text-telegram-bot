...
Команда показывает активных пользователей, полученные и успешно обработанные voice, ошибки, блокировки лимитом, минуты аудио, открытия истории/профиля, share clicks, paywall views и базовые conversion rates.
