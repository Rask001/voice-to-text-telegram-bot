...
Анализ генерируется в том же OpenAI-запросе, что summary/tasks/details. Отдельного OpenAI-запроса нет.
...
Тип голосового и класс воды нормализуются локально: тип следует многословности, а класс воды — индексу воды. Это защищает от противоречий вроде `Многословность 2.0`, но `Тип: Подкастер`.
